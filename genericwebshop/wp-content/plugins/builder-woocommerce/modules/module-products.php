		...
		$button = array(
			...
			self::get_expand('f', array(
				...
				'n' => array(
					...
					self::get_text_align(array(' .product .add_to_cart_button', ' .carousel-wrap .add_to_cart_button'),'t_a_p_b'),
				...
				'h' => array(
					...
					self::get_text_align(array(' .product .add_to_cart_button', ' .carousel-wrap .add_to_cart_button'),'t_a_p_b','h'),
